...
For numerical correctness issues, include the matrix properties you expect, the right-hand side, solver settings, residuals, and a reference result if available. HyBIT 0.5.0 is experimental and currently targets real SPD systems on its automatic path.
